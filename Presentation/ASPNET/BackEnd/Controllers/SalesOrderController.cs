...
public class SalesOrderController : BaseApiController
{
    ...
    [HttpPost("UpdateSalesOrderDiscount")]
    public async Task<IActionResult> UpdateSalesOrderDiscount([FromBody] UpdateSalesOrderDiscountRequest request, CancellationToken cancellationToken)
    {
